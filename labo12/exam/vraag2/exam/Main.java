...
public class Main {
	...
	// Pas indien nodig de Book class aan, maar zorg dat bovenstaande opgaves blijven werken.
	...
	// 1P
	// Gebruik enkel streams
	// Maak een collectie met alle boektitels van boeken voor 1950, verwijderd duplicaten en sorteer deze op year oplopend.
	...
	// 1P
	// Gebruik enkel streams
	// Bereken het aantal unieke boeken waarvan de title met een 'D' begint en geschreven zijn tussen 1950 en 1980.
